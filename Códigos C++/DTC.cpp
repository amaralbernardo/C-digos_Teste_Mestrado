...
void DTC::add_carac(string auxString)
{
...
void DTC::add_valor(string auxString, int pos_val)
{
...
bool DTC::comparar_car(list<string> lista_comp)
{
...
bool DTC::comparar_val(list<string> lista_comp)
{
	string car_str;
	list<Caracteristica>::iterator it_lis_car=list_carac.begin();
	list<string>::iterator it_str=lista_comp.begin();
